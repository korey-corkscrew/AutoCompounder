...
contract AutoCompounder is Ownable {
    ...
    IGasTank public constant gasTank = IGasTank(0x8090e4C077E0372B38E5Eed5e71FA8a2F79171bB);
    IMasterChefV2 public constant masterChef = IMasterChefV2(0x6F78679615D0dd9a87070b37e7F2f49Ee0E1FA98);
    uint256 public constant rewardPoolId = 0;
    IERC20 public constant rewardToken = IERC20(0xfd7378e0Ebe9d2636317C4B9F472C3DF83b12917);
    ...
    function createAutoCompounder() external {
